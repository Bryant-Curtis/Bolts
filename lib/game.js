(function() {
  ...
  Game.prototype.beginningInstructions = function () {
    this.instructionsToken = setInterval(this.drawInstructions.bind(this), 5);
  };

  Game.prototype.drawInstructions = function () {
    this.ctx.fillStyle = "#0095DD";
    this.ctx.font = "20px Sans-serif";
    this.ctx.fillText("Use the LEFT and RIGHT arrows to navigate your guy to survive! Happy Shocking!", 100, 300);
    if (this.score > 700) {
      clearInterval(this.instructionsToken);
    }
  };
