(function() {
  ...
  Game.prototype.gameOver = function (player) {
    this.cancelLoops();
    this.drawInstructions(); // REFACTOR OUT
    this.goToEndScreen();
    ...
    // change the classes of the canvas and the end game screen
    // to hide and show respectively, showing the end game screen.
  };

  Game.prototype.cancelLoops = function () {
    clearInterval(playerExplosionToken);
    clearInterval(scoreToken);
    clearInterval(this.instructionsToken); // REFACTOR OUT
